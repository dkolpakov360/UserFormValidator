...
Домашнее задание состоит из нескольких небольших отдельных не связанных между собой задач (кроме
CMS). Каждое задание делается в отдельном файле с уникальным пространством имен .
